...
# Función para generar un individuo (valores dentro de los límites de la función Griewank)
def create_individual_griewank():
    return [random.uniform(-600, 600) for _ in range(10)]  # 10 dimensiones

# Registrar la función de creación de individuos en el toolbox
toolbox.register("individual", tools.initIterate, creator.Individual, create_individual_griewank)

# Registrar la población
toolbox.register("population", tools.initRepeat, list, toolbox.individual)

# Registrar la función de evaluación (función Griewank)
def evaluate_griewank(individual):
...
toolbox.register("evaluate", evaluate_griewank)
